...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'SDinu;Skl11;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    ...
    BOT_NAME: process.env.BOT_NAME || 'MD-WAbot',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣¹¹ꫂ;SDinu MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
